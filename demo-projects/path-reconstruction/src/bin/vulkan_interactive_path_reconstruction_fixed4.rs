...
//!
//! ```text
//! demo-projects/path-reconstruction/src/bin/vulkan_interactive_path_reconstruction_fixed4.rs
//! ```
//!
//! Run:
//!
//! ```sh
//! ROCM_OXIDE_VISUAL_PRESENT=vulkan cargo run --bin vulkan_interactive_path_reconstruction_fixed4
//! ```
//!
//! Bounded run:
//!
    ...
    while window.is_open() && !window.is_key_down(Key::Escape) {
        ...
        if rendered_frames % 30 == 0 {
            ...
            window.set_title(&format!(
                "Interactive Path Reconstruction | samples={} recon={} selected={} material={} aperture={:.3} focus={:.2}",
                sample_index + 1,
                reconstruction,
                selected_name,
                material_preset,
