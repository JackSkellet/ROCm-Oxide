...
//!
//! ```text
//! demo-projects/path-reconstruction/src/bin/vulkan_interactive_path_reconstruction_motion_denoise_v2.rs
//! ```
//!
//! Run:
//!
//! ```sh
//! ROCM_OXIDE_VISUAL_PRESENT=vulkan cargo run --bin vulkan_interactive_path_reconstruction_motion_denoise_v2
//! ```
//!
//! Bounded run:
//!
