...
//!
//! ```text
//! demo-projects/path-reconstruction/src/bin/vulkan_path_reconstruction.rs
//! ```
//!
//! Run with Vulkan presentation:
//!
//! ```sh
//! ROCM_OXIDE_VISUAL_PRESENT=vulkan cargo run --bin vulkan_path_reconstruction
//! ```
//!
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "controls: Esc quit | Space reconstruction | R reset | Up/Down exposure | A/D aperture | Left/Right focus"
    );
