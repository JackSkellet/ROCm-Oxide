...
See [docs/stability-policy.md](stability-policy.md) for the full stability
commitment.
...
| `docs/hello_gpu.md` | ✓ | HIPRTC walkthrough |
| `docs/hello_gpu_rust.md` | ✓ | Rust device-kernel walkthrough |
| `docs/api_overview.md` | ✓ | Fixed generated binding types |
| `docs/troubleshooting.md` | ✓ | Error-by-error guide |
| `docs/project_generation.md` | ✓ | Scaffold docs |
| `docs/api-stability.md` | ✓ | Stable vs experimental surface |
| `docs/stability-policy.md` | ✓ | Experimental SDK commitment |
| `docs/supported-rocm-gpu-matrix.md` | ✓ | GPU/ROCm matrix |
| `docs/release-gates.md` | ✓ | CI and promotion rules |
| `docs/release_checklist.md` | ✓ | This document |
...
- [ ] `docs/supported-rocm-gpu-matrix.md` reflects the validated ROCm version
...
- [ ] `docs/stability-policy.md` exists and disclaims experimental status
