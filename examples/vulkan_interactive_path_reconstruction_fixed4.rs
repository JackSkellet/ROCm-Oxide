...
//!
//! ```sh
//! ROCM_OXIDE_VISUAL_PRESENT=vulkan cargo run --features visual-demos --example vulkan_interactive_path_reconstruction_fixed4
//! ```
//!
//! Bounded run:
//!
//! ```sh
//! ROCM_OXIDE_VISUAL_PRESENT=vulkan cargo run --features visual-demos --example vulkan_interactive_path_reconstruction_fixed4 -- --frames 300
//! ```
//!
